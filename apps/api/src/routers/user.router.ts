...
import {loginUserValidator,registerUserValidator,forgetPasswordUserValidator,resetPasswordValidator,
verificationUserValidator, handleValidator,} from '@/middlewares/expressValidator';
...
router.post('/verification/validate', userController.verificationValidateToken,);
